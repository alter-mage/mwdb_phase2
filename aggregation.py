...
def group_by_type(metadata, y, feature_model):
    ...
    return sorted(type_image_map), data_matrix
...
def group_by_type_all(metadata, feature_model):
    ...
    return sorted(type_image_map), data_matrix, np.dot(data_matrix, data_matrix.transpose())
...
def group_by_subject(metadata, x, feature_model):
    ...
    return sorted(subject_image_map), data_matrix
...
def group_by_subject_all(metadata, feature_model):
    ...
    return sorted(subject_image_map), data_matrix, np.dot(data_matrix, data_matrix.transpose())
